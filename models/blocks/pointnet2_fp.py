...
from utils.pointnet2_util import square_distance, index_points
...
class PointNetFeaturePropagation(nn.Cell):
    ...
    Input:
        ...
        xyz2: input points position data, [B, C, S]
    ...
    Examples:
        ...
        >> l2_xyz = Tensor(np.ones((24, 3, 128)),ms.float32)
    ...
    def construct(self, xyz1, xyz2, points1, points2):
        """FP construct"""
        xyz1 = self.transpose(xyz1, (0, 2, 1))
        xyz2 = self.transpose(xyz2, (0, 2, 1))
